...
#+begin_src
# cat /etc/letsencrypt/live/znc.example.org/{privkey,fullchain}.pem > znc.pem
# mv znc.pem /var/lib/znc/.znc/
...
#+begin_src
# touch /etc/letsencrypt/renewal-hooks/deploy/update-znc.pem
